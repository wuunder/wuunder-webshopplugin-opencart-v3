...
## Install ##
### Manual Install ###
* Download the .zip file from this repository from the latest stable version.
...
Next to manual installation the plugin can also be directly downloaded and installed from the [OpenCart marketplace.](https://www.opencart.com/index.php?route=marketplace/extension&filter_search=wuunder).
